  ...
  return (
    <div className="container py-12">
      ...
      <form className="max-w-md">
        ...
        <input type="password" placeholder="Confirmer mot de passe" className="w-full mb-4 p-2 border" />
        <button type="submit" className="bg-amber-900 text-white px-6 py-2">S'inscrire</button>
      </form>
    </div>
  )
}
